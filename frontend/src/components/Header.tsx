				...
				<div className="md:px-36 mr-10 w-full">
					<div className="w-full">
						<div className="flex justify-between w-full">
							...
							<div>
								{JSON.parse(localStorage.getItem("data") || "{}")?.role === "admin" && <button className="text-gray-800 mr-2 hover:bg-gray-100 transition-all ease-in duration-100 px-4 py-1 font-semibold rounded-md my-2 underline" onClick={() => pathname === "/dashboard" ? navigate("/") : navigate("/dashboard")}>
									{pathname === "/dashboard" ? "Review" : "Dashboard"}
								</button>}
